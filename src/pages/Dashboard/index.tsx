...
const Dashboard: React.FC = () => {
  ...
  const [editModalOpen, setModalEdit] = useState(false);
  ...
  const handleUpdateFood = async (food: IFoodProp) => {
    try {
  ...
  const toggleEditModal = () => {
    setModalEdit(!editModalOpen);
  };

  const handleEditFood = (food: IFoodProp) => {
    setEditing(food);
    setModalEdit(true);
  };
